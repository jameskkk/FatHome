			...
			<div className="colorlib-narrow-content">
				...
				<div className="row">
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small>July 22, 2022 </small> | <small> Web Design </small> | <small> <i className="icon-bubble3" /> 4</small></span>
							<h3><a href="blog.html">Renovating National Gallery</a></h3>
							<p>Separated they live in Taiwan right at the coast of the Semantics, a large language ocean.</p>
						</div>
					</div>
					</div>
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small>July 22, 2022</small> | <small> Inspiration </small> | <small> <i className="icon-bubble3" /> 4</small></span>
